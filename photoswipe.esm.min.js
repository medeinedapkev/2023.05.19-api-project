...
class M {
  ...
  correctZoomPan(t) {
    ...
    const c = s.bgOpacity,
      ...
      p = i({ x: 0, y: 0 }, h.pan);
    let u = i({ x: 0, y: 0 }, p);
    t && ((this.A.x = 0), (this.A.y = 0), (this.T.x = 0), (this.T.y = 0), (this.I = o), i(this.C, p)),
...
class T {
    ...
    (this.pswp = t),
      ...
      t.on("bindEvents", () => {
        t.events.add(t.scrollWrap, "click", this.$.bind(this)),
          this.N ? this.q("pointer", "down", "up", "cancel") : this.R ? (this.q("touch", "start", "end", "cancel"), t.scrollWrap && ((t.scrollWrap.ontouchmove = () => {}), (t.scrollWrap.ontouchend = () => {}))) : this.q("mouse", "down", "up");
      });
  }
  q(t, i, s, h) {
    const { pswp: e } = this,
  ...
  onPointerDown(t) {
    ...
    h.opener.isOpen
      ? h.dispatch("pointerDown", { originalEvent: t }).defaultPrevented ||
        (s && (h.mouseDetected(), this.H(t)), h.animations.stopAll(), this.K(t, "down"), 1 === this.F && ((this.dragAxis = null), i(this.startP1, this.p1)), this.F > 1 ? (this.W(), (this.isMultitouch = !0)) : (this.isMultitouch = !1))
      : t.preventDefault();
  }
  onPointerMove(t) {
    t.preventDefault(),
  ...
  onPointerUp(t) {
    this.F &&
      ...
      this.pswp.dispatch("pointerUp", { originalEvent: t }).defaultPrevented ||
        (0 === this.F && (this.Y(), this.isDragging ? this.j() : this.isZooming || this.isMultitouch || this.st(t)), this.F < 2 && this.isZooming && ((this.isZooming = !1), this.zoomLevels.end(), 1 === this.F && ((this.dragAxis = null), this.X()))));
  }
  J() {
    (this.isDragging || this.isZooming) &&
      (this.it(), this.isDragging ? e(this.p1, this.prevP1) || this.drag.change() : (e(this.p1, this.prevP1) && e(this.p2, this.prevP2)) || this.zoomLevels.change(), this.ht(), (this.raf = requestAnimationFrame(this.J.bind(this))));
  }
  it(t) {
    const s = Date.now(),
      h = s - this.U;
  ...
  K(t, s) {
    if (this.N) {
      ...
      const i = t;
      (this.F = 0),
        i.type.indexOf("touch") > -1 ? i.touches && i.touches.length > 0 && (this.nt(i.touches[0], this.p1), this.F++, i.touches.length > 1 && (this.nt(i.touches[1], this.p2), this.F++)) : (this.nt(t, this.p1), "up" === s ? (this.F = 0) : this.F++);
    }
  }
  ht() {
...
const U = {
  ...
  G = { name: "close", title: "Close", order: 20, isButton: !0, html: { isCustomSVG: !0, inner: '<path d="M24 10l-2-2-6 6-6-6-2 2 6 6-6 6 2 2 6-6 6 6 2-2-6-6z" id="pswp__icn-close"/>', outlineID: "pswp__icn-close" }, onClick: "close" },
  $ = {
    name: "zoom",
    title: "Zoom",
    order: 10,
...
class Y {
  ...
  onError() {
    (this.state = d), this.slide && (this.displayError(), this.instance.dispatch("loadComplete", { slide: this.slide, isError: !0, content: this }), this.instance.dispatch("loadError", { slide: this.slide, content: this }));
  }
  isLoading() {
  ...
  setDisplayedSize(t, i) {
    if (
      this.element &&
      (this.placeholder && this.placeholder.setDisplayedSize(t, i), !this.instance.dispatch("contentResize", { content: this, width: t, height: i }).defaultPrevented && (c(this.element, t, i), this.isImageContent() && !this.isError()))
    ) {
      const s = !this.displayedImageWidth && t;
      (this.displayedImageWidth = t), (this.displayedImageHeight = i), s ? this.loadImage(!1) : this.updateSrcsetSizes(), this.slide && this.instance.dispatch("imageSizeChange", { slide: this.slide, width: t, height: i, content: this });
    }
  }
  isZoomable() {
  ...
  destroy() {
    (this.hasSlide = !1),
      ...
      this.instance.dispatch("contentDestroy", { content: this }).defaultPrevented ||
        (this.remove(), this.placeholder && (this.placeholder.destroy(), (this.placeholder = void 0)), this.isImageContent() && this.element && ((this.element.onload = null), (this.element.onerror = null), (this.element = void 0)));
  }
  displayError() {
    if (this.slide) {
  ...
  remove() {
    (this.isAttached = !1),
      this.instance.dispatch("contentRemove", { content: this }).defaultPrevented || (this.element && this.element.parentNode && this.element.remove(), this.placeholder && this.placeholder.element && this.placeholder.element.remove());
  }
  appendImage() {
    this.isAttached &&
      (this.instance.dispatch("contentAppendImage", { content: this }).defaultPrevented ||
        (this.slide && this.element && !this.element.parentNode && this.slide.container.appendChild(this.element), (this.state !== u && this.state !== d) || this.removePlaceholder()));
  }
}
function J(t, i, s) {
...
class tt {
  ...
  Vt() {
    ...
    if (
      ...
      return (this.It = 0), (this.$t = !1), (this.Zt = !1), (this.kt = !0), void (this.isOpening && (t.element && (t.element.style.opacity = String(0.003)), t.applyBgOpacity(1)));
    this.$t && this.Nt && this.Nt.innerRect
      ...
      : (this.Lt = !1),
      this.isOpening
        ? (this.kt ? (t.element && (t.element.style.opacity = String(0.003)), t.applyBgOpacity(1)) : (this.Zt && t.bg && (t.bg.style.opacity = String(0.003)), t.element && (t.element.style.opacity = "1")),
          this.$t && (this.qt(), this.Bt && ((this.Bt.style.willChange = "transform"), (this.Bt.style.opacity = String(0.003)))))
        : this.isClosing &&
